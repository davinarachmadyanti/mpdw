...
```{r}
input = read.csv("C:/Users/62822/Documents/IPB/KULIAH/SEMESTER 5/Metode Peramalan Deret Waktu/mpdw/P2/Wine Data.csv",sep=";")
input
...
```{r}
#Transformasi Manual
Production.trans<- data$Production[-1]-data$Production[-12]*rho
Year.trans<- data$Year[-1]-data$Year[-12]*rho
HarvestedAcres.trans<- data$HarvestedAcres[-1]-data$HarvestedAcres[-12]*rho
...
Berdasarkan hasil tersebut dapat diketahui bahwa hasil penanganan autokorelasi dengan metode *Cochrane-Orcutt* dan *Hildreth-Lu* memiliki SSE berturut-turut, sebesar $4954702979$ dan $507848894$ yang mana lebih kecil sehingga lebih baik dibandingkan model awal ketika autokorelasi masih terjadi, yaitu sebesar $11837263935$.
